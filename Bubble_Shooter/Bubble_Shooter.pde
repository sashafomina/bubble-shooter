...
void draw() {
  ...
  if (_gameScreen == 1 &&!_lose && !_win) { //This is for the actual game
    ...
    _font = loadFont("AvenirNext-Heavy-38.vlw");
    textFont(_font);
    textSize(38);  
    fill(142, 212, 242);
    text("BUBBLE SHOOTER", 37, 340);
    _font = loadFont("AppleSDGothicNeo-UltraLight-28.vlw");
    textFont(_font);
    textSize(28);
    fill(62, 134, 165);
    text("STRINGCHEESE", 115, 369);
    _font = loadFont("AppleSDGothicNeo-UltraLight-18.vlw");
    textFont(_font);
    textSize(18);
    text("Sasha Fomina, Daniel Ju, Kevin Li", 87, 387);
    launch(test);
    snap();
    shiftDown();
    checkLose();
...
void initScreen() { //The start screen
  background(240, 119, 6);
  _font = loadFont("AvenirNext-Heavy-38.vlw");
  textFont(_font);
  textSize(38);  
  fill(6, 241, 210);
  text("BUBBLE SHOOTER", 36, 150);
  textFont(_font);
  textSize(24);
  fill(255);
  text("STRINGCHEESE", 36, 200);
  textFont(_font);
  textSize(18);
  text("Sasha Fomina, Daniel Ju, Kevin Li", 36, 216);
  fill(255);
  text("Click Anywhere to Begin", 87, 550);
}
...
void gameOverScreen() { //The end screen
  ...
  fill(6, 241, 210);
  if (_lose) {
    text("YOU LOSE :(", 36, 150);
  } else {
    text("YOU WINNN!!", 36, 150);
  }
  textFont(_font);
  textSize(24);
  fill(255);
  ...
  fill(6, 241, 210);
  textSize(20);
  text("Start Again", 140, 475);
  fill(0, 0, 0);
  text("Your Score is: " + _bubbleField.getScore(), 36, 300); //Display player score
  text("Largest Cluster Popped: " + _bubbleField.getLargestCluster(), 36, 340); //Display largest popped cluster
}
